...
public class ProductsController {
	...
	@GetMapping("/getByProductsNameAndCategory")
	public DataResult<Product> getByProductsNameAndCategory(@RequestParam String productName, @RequestParam int categoryId){
